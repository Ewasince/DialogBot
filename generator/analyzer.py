class Analyzer:
    def __init__(self, date_analyzer=None):
        ...
        self.letters_pos = {}
        self.dicts['letters_pos'] = self.letters_pos
        self.letters_pos_by_word = {}
        self.dicts['letters_pos_by_word'] = self.letters_pos_by_word
        self.words_len = {}
    ...
    def analyze_letters_pos(self, n, letter):
        ...
        pos_dict = self.letters_pos.setdefault(str(n), dict())
    ...
    def analyze_letters_pos_by_word(self, n, word, letter):
        ...
        len_dict = self.letters_pos_by_word.setdefault(str(len(word)), dict())
